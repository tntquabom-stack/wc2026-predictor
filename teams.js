const TEAMS = [
  // Group A
  { id: "mexico", name: "Mexico", vnName: "Mexico", group: "A", rank: 15, attack: 79, defense: 77, host: true, flagCode: "mx" },
  { id: "south_africa", name: "South Africa", vnName: "Nam Phi", group: "A", rank: 59, attack: 70, defense: 69, host: false, flagCode: "za" },
  { id: "korea", name: "South Korea", vnName: "Hàn Quốc", group: "A", rank: 22, attack: 78, defense: 76, host: false, flagCode: "kr" },
  { id: "czechia", name: "Czechia", vnName: "CH Séc", group: "A", rank: 36, attack: 76, defense: 75, host: false, flagCode: "cz" },

  // Group B
  { id: "canada", name: "Canada", vnName: "Canada", group: "B", rank: 40, attack: 75, defense: 73, host: true, flagCode: "ca" },
  ...
  { id: "switzerland", name: "Switzerland", vnName: "Thụy Sĩ", group: "B", rank: 14, attack: 85, defense: 85, host: false, flagCode: "ch" },

  // Group C
  { id: "brazil", name: "Brazil", vnName: "Brazil", group: "C", rank: 5, attack: 91, defense: 85, host: false, flagCode: "br" },
  { id: "morocco", name: "Morocco", vnName: "Ma-rốc", group: "C", rank: 11, attack: 86, defense: 86, host: false, flagCode: "ma" },
  ...
  // Group D
  { id: "usa", name: "United States", vnName: "Mỹ", group: "D", rank: 13, attack: 82, defense: 78, host: true, flagCode: "us" },
  ...
  // Group E
  { id: "germany", name: "Germany", vnName: "Đức", group: "E", rank: 15, attack: 88, defense: 84, host: false, flagCode: "de" },
  ...
  { id: "japan", name: "Japan", vnName: "Nhật Bản", group: "F", rank: 18, attack: 83, defense: 81, host: false, flagCode: "jp" },
  ...
  // Group G
  { id: "belgium", name: "Belgium", vnName: "Bỉ", group: "G", rank: 6, attack: 90, defense: 86, host: false, flagCode: "be" },
  ...
  // Group H - Champions Spain
  { id: "spain", name: "Spain", vnName: "Tây Ban Nha", group: "H", rank: 1, attack: 96, defense: 93, host: false, flagCode: "es" },
  ...
  { id: "uruguay", name: "Uruguay", vnName: "Uruguay", group: "H", rank: 16, attack: 84, defense: 82, host: false, flagCode: "uy" },

  // Group I
  { id: "france", name: "France", vnName: "Pháp", group: "I", rank: 3, attack: 94, defense: 89, host: false, flagCode: "fr" },
  ...
  { id: "norway", name: "Norway", vnName: "Na Uy", group: "I", rank: 12, attack: 88, defense: 82, host: false, flagCode: "no" },

  // Group J - Runners up Argentina
  { id: "argentina", name: "Argentina", vnName: "Argentina", group: "J", rank: 2, attack: 95, defense: 91, host: false, flagCode: "ar" },
  ...
  // Group K
  { id: "portugal", name: "Portugal", vnName: "Bồ Đào Nha", group: "K", rank: 8, attack: 89, defense: 85, host: false, flagCode: "pt" },
  ...
  { id: "colombia", name: "Colombia", vnName: "Colombia", group: "K", rank: 10, attack: 86, defense: 84, host: false, flagCode: "co" },

  // Group L
  { id: "england", name: "England", vnName: "Anh", group: "L", rank: 4, attack: 92, defense: 88, host: false, flagCode: "gb-eng" },
  { id: "croatia", name: "Croatia", vnName: "Croatia", group: "L", rank: 13, attack: 82, defense: 83, host: false, flagCode: "hr" },
